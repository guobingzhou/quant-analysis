...
RUN R --quiet -e "install.packages(c('png', 'reticulate','fAsset','fArma','fGarch','fOpions','fCopulae','PerformanceAnalytics','PortfolioAnalytics','fUnitRoots','ftrading','quantstart','blotter'), repos = 'https://mirrors.tuna.tsinghua.edu.cn/CRAN/')" &&\
    rm -rf /tmp/*
...
# RUN pip install pandas-ta tradingwithPython
